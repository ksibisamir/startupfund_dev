...
@section('content')
            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="jumbotron-button-wrap">
                        @if(!Auth::user() or (Auth::user() and Auth::user()->is_investor_business_angel()) )
                            <a class="invested-btn @if(!Auth::user()) invested-not-logged-btn @endif"
                               href="{{route('register')}}">@lang('app.support_campaigns')</a>
                        @endif
                        @if(!Auth::user() or (Auth::user() and Auth::user()->is_startup()))
                            <a class="main-btn main-btn-gradient start-crowdfunding-btn  @if(!Auth::user()) start-crowdfunding-not-logged-btn @endif"
                               href="{{route('register_startup')}}">@lang('app.start_crowdfunding')</a>
                        @endif
                    </div>
                </div>
            </div>
    ...
    <section class="home-campaign section-bg-white why_choose_us">
        <div class="container">
            <div>
                <h2 class="section-title">@lang('app.why_choose_us') </h2>
                <p class="sub-title">@lang('app.why_choose_us_description')</p>
            </div>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="why-choose-us-box">
                        ...
                        <div class="title">
                            <h4 class="security">@lang('app.security')</h4>
                        </div>
                        <div class="desc">
                            @lang('app.security_desc')
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="why-choose-us-box">
                        ...
                        <div class="title">
                            <h4 class="facility">@lang('app.facility')</h4>
                        </div>
                        <div class="desc">
                            @lang('app.facility_desc')
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="why-choose-us-box">
                        ...
                        <div class="title">
                            <h4 class="guarantee">@lang('app.guarantee')</h4>
                        </div>
                        <div class="desc">
                            @lang('app.guarantee_desc')
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="why-choose-us-box">
                        ...
                        <div class="title">
                            <h4 class="legal">@lang('app.legal')</h4>
                        </div>
                        <div class="desc">
                            @lang('app.legal_desc')
                        </div>
    ...
    <section class="home-campaign section-bg-gray"> <!-- explore categories -->
        <div class="container">
            ...
            <div>
                <h2 class="section-title"><span class="border-bottom"> @lang('app.explore_categories')</span></h2>
            </div>
    ...
    @if($staff_picks->count() > 0)
        ...
        <section class="home-campaign section-bg-white">
            <div class="container">
                ...
                <div>
                    <h2 class="section-title"><span class="border-bottom">@lang('app.staff_picks')</span></h2>
                </div>


                <div class="row">
                    @if($staff_picks->count() > 4 )
                        @php
                            $mod0 = (int)($staff_picks->count()/3);
                        @endphp
                        <div class="box-campaign-lists">
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 box-campaign-item">
                                @foreach($staff_picks as $nc)
                                    @if($loop->index % $mod0 == 0 && $loop->index != 0)
                            </div>
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 box-campaign-item">
                                <div class="box-campaign">
                                    <div class="box-campaign-image">
                                        <a href="{{route('campaign_single', [$spc->id, $spc->slug])}}"> <img
                                                    src="{{ $spc->feature_img_url()}}"/></a>
                                        <div class="overlay">
                                            <a class="info"
                                               href="{{route('campaign_single', [$spc->id, $spc->slug])}}">@lang('app.view_details')</a>
                                        </div>
                                    </div>
                                    <div class="box-campaign-content">
                                        <div class="box-campaign-description">
                                            <h4>
                                                <a href="{{route('campaign_single', [$spc->id, $spc->slug])}}"> {{$spc->title}} </a>
                                            </h4>
                                            <p>{{$spc->short_description}}</p>
                                        </div>

                                        <div class="box-campaign-summery red">
                                            <ul>
                                                <li><strong>{{$spc->days_left()}}</strong> @lang('app.days_left')</li>
                                                <li><strong>{{$spc->total_payments}}</strong> @lang('app.backers')</li>
                                                <li>
                                                    <strong>{!! get_amount($spc->total_raised()) !!}</strong> @lang('app.funded')
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                @else
                                    <div class="box-campaign">
                                        ...
                                        <div class="box-campaign-content">
                                            ...
                                            <div class="box-campaign-summery red">
                                                <ul>
                                                    <li><strong>{{$spc->days_left()}}</strong> @lang('app.days_left')
                                                    </li>
                                                    <li><strong>{{$spc->total_payments}}</strong> @lang('app.backers')
                                                    </li>
                                                    <li>
                                                        <strong>{!! get_amount($spc->total_raised()) !!}</strong> @lang('app.funded')
                                                    </li>
    ...
    @if($new_campaigns->count() > 0)
        <section class="home-campaign section-bg-gray new-home-campaigns">
            <div class="container">
                ...
                <div>
                    <h2 class="section-title"><span class="border-bottom">@lang('app.new_campaigns')</span></h2>
                </div>
                @php

                $nbreLine = (int) ($new_campaigns->count() / 3);
                $rest = $new_campaigns->count() % 4;

                if($rest == 0) {
                $rest = $new_campaigns->count();
                $nbreLine--;
                }
                if($new_campaigns->count() == 5) {
                                 $nbreLine=2;
                                 }
                                 if($new_campaigns->count() < 5) {
                                 $nbreLine=1;
                ...
                <div class="row">
                    <div class="box-campaign-lists">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 box-campaign-item">
                            <div class="box-campaign">
                                <div class="box-campaign-image">
                                    <a href="{{route('campaign_single', [$nc->id, $nc->slug])}}"><img
                                                src="{{ $nc->feature_img_url()}}"/> </a>
                                    <div class="overlay">
                                        <a class="info"
                                           href="{{route('campaign_single', [$nc->id, $nc->slug])}}">@lang('app.view_details')</a>
                                    </div>
                                </div>
                                <div class="box-campaign-content">
                                    <div class="box-campaign-description">
                                        <h4>
                                            <a href="{{route('campaign_single', [$nc->id, $nc->slug])}}"> {{$nc->title}} </a>
                                        </h4>
                                    ...
                                    <div class="box-campaign-summery">
                                        <ul>
                                            ...
                                            <li>
                                                <strong>{!! get_amount($nc->total_raised()) !!}</strong> @lang('app.funded')
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            @else
                                <div class="box-campaign">
                                    ...
                                    <div class="box-campaign-content">
                                        ...
                                        <div class="box-campaign-summery">
                                            <ul>
                                                <li><strong>{{$nc->days_left()}}</strong> @lang('app.days_left')
                                                </li>
                                                <li><strong>{{$nc->total_payments}}</strong> @lang('app.backers')
                                                </li>
                                                <li>
                                                    <strong>{!! get_amount($nc->total_raised()) !!}</strong> @lang('app.funded')
                                                </li>
                ...
                <div class="section-footer">
                    @if($new_campaigns->nextPageUrl())
                        <a href="{{$new_campaigns->nextPageUrl()}}" class="section-action-btn loadMorePagination">
                            <span id="load_more_indicator"></span> @lang('app.load_more')</a>
                    @else
                        <a href="javascript:;" class="section-action-btn"
                           onclick="return alert('@lang('app.no_more_results')')">
                            <span></span> @lang('app.no_more_results')</a>
                    @endif
    ...
    @if($funded_campaigns->count() && false)
        <section class="home-campaign section-bg-white">
            <div class="container">
                <h2 class="section-title"><span class="border-bottom">@lang('app.recently_funded_campaigns')</span></h2>

                <div class="row">
                    @if($funded_campaigns->count() > 4 )
                        @php
                            $mod2 = (int)($funded_campaigns->count()/3);
                        @endphp
                        <div class="box-campaign-lists">
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 box-campaign-item">
                                @foreach($funded_campaigns as $nc)
                                    @if($loop->index % $mod2 == 0 && $loop->index != 0)
                            </div>
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 box-campaign-item">
                                <div class="box-campaign">
                                    <div class="box-campaign-image">
                                        <a href="{{route('campaign_single', [$fc->id, $fc->slug])}}"><img
                                                    src="{{ $fc->feature_img_url()}}"/> </a>
                                        <div class="overlay">
                                            <a class="info"
                                               href="{{route('campaign_single', [$fc->id, $fc->slug])}}">@lang('app.view_details')</a>
                                        </div>
                                    </div>
                                    <div class="box-campaign-content">
                                        <div class="box-campaign-description">
                                            <h4>
                                                <a href="{{route('campaign_single', [$fc->id, $fc->slug])}}"> {{$fc->title}} </a>
                                            </h4>
                                        ...
                                        <div class="box-campaign-summery">
                                            <ul>
                                                ...
                                                <li>
                                                    <strong>{!! get_amount($fc->total_raised()) !!}</strong> @lang('app.funded')
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                @else
                                    <div class="box-campaign">
                                        ...
                                        <div class="box-campaign-content">
                                            ...
                                            <div class="box-campaign-summery">
                                                <ul>
                                                    <li><strong>{{$fc->days_left()}}</strong> @lang('app.days_left')
                                                    </li>
                                                    <li><strong>{{$fc->total_payments}}</strong> @lang('app.backers')
                                                    </li>
                                                    <li>
                                                        <strong>{!! get_amount($fc->total_raised()) !!}</strong> @lang('app.funded')
                                                    </li>
...
">
            <div class="row  hidden-xs">
                <div class="col-sm-4 ">
                    <span class="circular"><h3>{{$campaigns_count}}</h3> <h4>@lang('app.campaigns')</h4></span></div>
                <div class="col-sm-4"><span
                            class="circular"><h3>{!! get_amount($fund_raised_count) !!}</h3> <h4>@lang('app.funds_raised')</h4></span>
                </div>
                <div class="col-sm-4"><span
                            class="circular"><h3>{{$users_count}}</h3> <h4>@lang('app.users')</h4></span></div>
            </div>

            <div class="banner hidden visible-xs">
                <section id="dg-container" class="dg-container">
                    <div class="dg-wrapper">
                        <a href="">
                            <span class="circular"><h3>{{$campaigns_count}}</h3> <h4>@lang('app.campaigns')</h4></span>
                        </a>
                        <a href="">
                            <span class="circular"><h3>{!! get_amount($fund_raised_count) !!}</h3> <h4>@lang('app.funds_raised')</h4></span>
                        </a>
                        <a href="" >
                            <span class="circular"><h3>{{$users_count}}</h3> <h4>@lang('app.users')</h4></span>
                        </a>
                        <a href="">
                            <span class="circular"><h3>{{$campaigns_count}}</h3> <h4>@lang('app.campaigns')</h4></span>
                        </a>
                    ...
                    <ol class="button" id="lightButton">
                        ...
                        <li index="1">
                        <li index="2">
                        <li index="3" style="visibility: hidden">
                    </ol>
                    <nav>
...
{{--    padding-right: 50px;--}}
{{--">--}}
{{--            <h2 class="section-title"><span class="border-bottom">@lang('app.our_partners')</span></h2>--}}
{{--            <div class="row" style="padding-bottom: 50px;">--}}
{{--                <div class="col-sm-6 ">--}}
{{--                    <a href="http://www.attijaribank.com.tn/Fr/" target="_blank"><img src="{{ asset('assets/images/attijari_bank.png') }}"/> </a>--}}
{{--                </div>--}}
{{--                <div class="col-sm-4 souk-financier">--}}
{{--                    <a href="https://www.cmf.tn/"  target="_blank"><img src="{{ asset('assets/images/souk_financier.png') }}" class=""/> </a>--}}
{{--                </div>--}}
{{--                <div class="col-sm-6 ">--}}
{{--                    <a href="https://www.ajyalcapital.tn/"  target="_blank"><img src="{{ asset('assets/images/ajyal_capita.png') }}"/> </a>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </section>--}}
    @if (env('SHOW_DISCLAIMER'))
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel"> @lang("disclaimer.title")</h4>
                    </div>
