...
@section('content')
    <section class="investor-contract-validation">
        <div class="container">
            <a class="print" href="{{ asset('/pdf/STARTUP_FUND_CG_Plateforme-Porteurs_de_projets_.pdf') }}" target="_blank"><i
                        class="fa fa-print"></i> @lang('app.print')</a>
            <form id="register-form" class="form-horizontal" role="form" method="POST" action="{{ route('startup_accept_contract') }}">
                {{ csrf_field() }}
                <div class="sub-container">
                    @lang('contract.startup.content')
