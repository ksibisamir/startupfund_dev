...
<body>
  <div class="container-fluid" id="wrapper">
    ...
    <div class="row">
      ...
      <ul id="fab" class="mfb-component--br mfb-zoomin">
        <li>
          <a href="#"></a>
          <ul class="">
            <li class="mfb-component__wrap" style="list-style: none">
              <a href="#" id="add-folder" data-mfb-label="{{ trans('laravel-filemanager::lfm.nav-new') }}" title="{{ trans('laravel-filemanager::lfm.nav-new') }}">
                <i class="fa fa-2x  fa-folder"></i>
              </a>
            </li>
            <li class="mfb-component__wrap" style="list-style: none">
              <a href="#" id="upload" data-mfb-label="{{ trans('laravel-filemanager::lfm.nav-upload') }}" title="{{ trans('laravel-filemanager::lfm.nav-upload') }}">
