    ...
    <div class="row">
        <div class="col-sm-8 col-sm-offset-1 col-xs-12">
            ...
            <div class="form-group {{ $errors->has('category_name')? 'has-error':'' }}">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="category_name" value="{{ old('category_name') }}"
                ...
                <table class="table table-bordered categories-lists">
                    ...
                    @foreach($categories as $category)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('edit_categories', $category->id) }}" class="btn btn-info btn-xs"><i
                                            class="fa fa-pencil"></i> </a>
                                <a href="javascript:;" class="btn btn-danger btn-xs" data-id="{{ $category->id }}"><i
