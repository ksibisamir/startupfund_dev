...
@section('content')
    ...
    @if(Auth::user()->is_admin())
                ...
                <tr>
                    <td>{!! Form::open() !!}
                        ...
                        <button type="submit" class="btn btn-success"><i
                                    class="fa fa-check-circle-o"></i> @lang('app.approve')</button>
                        {!! Form::close() !!}
                    </td>
                    <td>
                        {!! Form::open() !!}
                        <input type="hidden" name="type" value="declined">
                        <button type="submit" class="btn btn-danger"><i class="fa fa-ban"></i> @lang('app.decline')
                        </button>
                        {!! Form::close() !!}
                    </td>
                </tr>
        ...
        @elseif($withdraw_request->status == 'declined')
            {!! Form::open() !!}
            <input type="hidden" name="type" value="approved">
            <button type="submit" class="btn btn-success"><i class="fa fa-check-circle-o"></i> @lang('app.approve')
            </button>
            {!! Form::close() !!}
        @endif
    @endif
