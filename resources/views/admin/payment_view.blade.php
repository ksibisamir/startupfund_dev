...
@section('content')
    ...
    <table class="table table-striped table-bordered">
        ...
        <tr>
            ...
            <td>@if($payment->user){{$payment->user->first_name}} {{$payment->user->name}}@endif</td>
        </tr>
        <tr>
    ...
    @if($payment->status != 'success')
        <a href="{{route('status_change', [$payment->id, 'success'] )}}" class="btn btn-success"><i
                    class="fa fa-check-circle-o"></i> @lang('app.mark_as_success') </a>
    @endif
@endsection