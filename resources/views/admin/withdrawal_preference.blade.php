        ...
        <div class="col-xs-12">
            ...
            <div class="form-group {{ $errors->has('default_withdrawal_account')? 'has-error':'' }}">
                <label for="email_address"
                       class="col-sm-4 control-label">@lang('app.default_withdrawal_account')</label>
                <div class="col-sm-8">
                    <fieldset>
                        <label><input type="radio" id="default_paypal" value="paypal" name="default_withdrawal_account"
                                      @if(withdrawal_preference() == 'paypal') checked="checked" @endif > @lang('app.paypal')
                        </label> <br/>
                        <label><input type="radio" id="default_bank" value="bank" name="default_withdrawal_account"
                                      @if(withdrawal_preference() == 'bank') checked="checked" @endif > @lang('app.bank')
                        </label> <br/>
                    </fieldset>
            ...
            <div class="config_wrap paypal-wrap"
                 style="display: @if(withdrawal_preference() == 'paypal') block @else none @endif;">
                ...
                <div class="form-group {{ $errors->has('paypal_email')? 'has-error':'' }}">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="paypal_email"
                               value="{{ withdrawal_preference('paypal_email') }}" name="paypal_email"
                               placeholder="@lang('app.paypal_email')">
                        {!! $errors->has('paypal_email')? '<p class="help-block">'.$errors->first('paypal_email').'</p>':'' !!}
                    </div>
                </div>
            </div>

            <div class="config_wrap bank-wrap"
                 style="display: @if(withdrawal_preference() == 'bank') block @else none @endif;">
                <div class="form-group {{ $errors->has('bank_account_holders_name')? 'has-error':'' }}">
                    <label for="bank_account_holders_name"
                           class="col-sm-4 control-label">@lang('app.bank_account_holders_name')</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="bank_account_holders_name"
                               value="{{ withdrawal_preference('bank_account_holders_name') }}"
                               name="bank_account_holders_name" placeholder="@lang('app.bank_account_holders_name')">
                ...
                <div class="form-group {{ $errors->has('bank_account_number')? 'has-error':'' }}">
                    <label for="bank_account_number"
                           class="col-sm-4 control-label">@lang('app.bank_account_number')</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="bank_account_number"
                               value="{{ withdrawal_preference('bank_account_number') }}" name="bank_account_number"
                               placeholder="@lang('app.bank_account_number')">
                ...
                <div class="form-group {{ $errors->has('swift_code')? 'has-error':'' }}">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="swift_code"
                               value="{{ withdrawal_preference('swift_code') }}" name="swift_code"
                               placeholder="@lang('app.swift_code')">
                ...
                <div class="form-group {{ $errors->has('bank_name_full')? 'has-error':'' }}">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="bank_name_full"
                               value="{{ withdrawal_preference('bank_name_full') }}" name="bank_name_full"
                               placeholder="@lang('app.bank_name_full')">
                ...
                <div class="form-group {{ $errors->has('bank_branch_name')? 'has-error':'' }}">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="bank_branch_name"
                               value="{{ withdrawal_preference('bank_branch_name') }}" name="bank_branch_name"
                               placeholder="@lang('app.bank_branch_name')">
                ...
                <div class="form-group {{ $errors->has('bank_branch_city')? 'has-error':'' }}">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="bank_branch_city"
                               value="{{ withdrawal_preference('bank_branch_city') }}" name="bank_branch_city"
                               placeholder="@lang('app.bank_branch_city')">
                ...
                <div class="form-group {{ $errors->has('bank_branch_address')? 'has-error':'' }}">
                    <label for="bank_branch_address"
                           class="col-sm-4 control-label">@lang('app.bank_branch_address')</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="bank_branch_address"
                               value="{{ withdrawal_preference('bank_branch_address') }}" name="bank_branch_address"
                               placeholder="@lang('app.bank_branch_address')">
