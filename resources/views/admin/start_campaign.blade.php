        ...
        <div class="col-md-10 col-xs-12">
            ...
            @if(Auth::user()->is_admin())
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="checkbox" class="input-group" id="for-purchase-funds" name="for_purchase_funds">
                    </div>
                </div>
            @endif
            ...
            <div class="form-group {{ $errors->has('goal')? 'has-error':'' }}">
                ...
                <div class="col-sm-8">
                    <input type="number" class="form-control" id="goal" value="{{ old('goal') }}" name="goal"
...
--}}
            ...
            <div class="form-group {{ $errors->has('amount_prefilled')? 'has-error':'' }}">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="amount_prefilled" value="{{ old('amount_prefilled') }}"
                           name="amount_prefilled" placeholder="@lang('app.amount_prefilled')">
                ...
                <div class="col-sm-8">
                    <label>
                        <input type="radio" name="end_method" value="goal_achieve"
                               @if( ! old('end_method') || old('end_method') == 'goal_achieve') checked="checked" @endif > @lang('app.after_goal_achieve')
                    </label> <br/>

                    <label>
                        <input type="radio" name="end_method" value="end_date"
                               @if(old('end_method') == 'end_date') checked="checked" @endif > @lang('app.after_end_date')
                    </label> <br/>
            ...
            <div class="form-group {{ $errors->has('start_date')? 'has-error':'' }}">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="start_date" value="{{ old('start_date') }}"
            ...
            <div class="form-group {{ $errors->has('end_date')? 'has-error':'' }}">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="end_date" value="{{ old('end_date') }}" name="end_date"
                           placeholder="@lang('app.end_date')">
