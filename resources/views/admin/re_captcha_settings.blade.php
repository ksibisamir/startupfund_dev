...
@section('content')
    ...
    <div id="social_login_settings_wrap">
        <div class="form-group {{ $errors->has('enable_recaptcha_login')? 'has-error':'' }}">
            ...
            <div class="col-md-8">
                <label for="enable_recaptcha_login" class="checkbox-inline">
                    <input type="checkbox" value="1" id="enable_recaptcha_login"
                           name="enable_recaptcha_login" {{ get_option('enable_recaptcha_login') == 1 ? 'checked="checked"': '' }}>
        ...
        <div class="form-group {{ $errors->has('enable_recaptcha_registration')? 'has-error':'' }}">
            ...
            <div class="col-md-8">
                <label for="enable_recaptcha_registration" class="checkbox-inline">
                    <input type="checkbox" value="1" id="enable_recaptcha_registration"
                           name="enable_recaptcha_registration" {{ get_option('enable_recaptcha_registration') == 1 ? 'checked="checked"': '' }}>
        ...
        <div class="form-group {{ $errors->has('enable_recaptcha_contact_form')? 'has-error':'' }}">
            ...
            <div class="col-md-8">
                <label for="enable_recaptcha_contact_form" class="checkbox-inline">
                    <input type="checkbox" value="1" id="enable_recaptcha_contact_form"
                           name="enable_recaptcha_contact_form" {{ get_option('enable_recaptcha_contact_form') == 1 ? 'checked="checked"': '' }}>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" id="site_key" value="{{ get_option('recaptcha_site_key') }}"
                       name="recaptcha_site_key" placeholder="@lang('app.site_key')">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" id="recaptcha_secret_key"
                       value="{{ get_option('recaptcha_secret_key') }}" name="recaptcha_secret_key"
                       placeholder="@lang('app.secret_key')">
            </div>
        </div>
    </div>
    <hr/>
