            ...
            <div class="form-group {{ $errors->has('site_name')? 'has-error':'' }}">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="site_name"
                           value="{{ old('site_name')? old('site_name') : get_option('site_name') }}" name="site_name"
                           placeholder="@lang('app.site_name')">
                ...
                <div class="col-sm-8">
                    <fieldset>
                        ...
                        <label><input type="radio" value="custom"
                            ...
                            Custom:</label>
                        <input type="text" value="{{ get_option('date_format_custom') }}" id="date_format_custom"
                ...
                <div class="col-sm-8">
                    <fieldset>
                        ...
                        <label><input type="radio" value="custom"
                            ...
                            Custom:</label>
                        <input type="text" value="{{ get_option('time_format_custom') }}" id="time_format_custom"
            ...
            <div class="form-group {{ $errors->has('enable_disqus_comment')? 'has-error':'' }}">
                ...
                <div class="col-md-8">
                    <label for="enable_disqus_comment" class="checkbox-inline">
                        <input type="checkbox" value="1" id="enable_disqus_comment"
                               name="enable_disqus_comment" {{ get_option('enable_disqus_comment') == 1 ? 'checked="checked"': '' }}>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="disqus_shortname"
                           ...
                           placeholder="@lang('app.disqus_shortname')">
