    ...
    <div class="row">
        <div class="col-sm-8 col-sm-offset-1 col-xs-12">
            ...
            <div class="form-group {{ $errors->has('amount')? 'has-error':'' }}">
                ...
                <div class="col-sm-8">
                    <input type="number" class="form-control" id="amount" value="{{ $reward->amount }}" name="amount"
            ...
            <div class="form-group {{ $errors->has('quantity')? 'has-error':'' }}">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="quantity" value="{{ $reward->quantity }}"
            ...
            <div class="form-group {{ $errors->has('estimated_delivery')? 'has-error':'' }}">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="estimated_delivery"
                           value="{{ $reward->estimated_delivery }}" name="estimated_delivery"
