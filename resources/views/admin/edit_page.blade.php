...
@section('content')
    @if( ! empty($title))
        <div>
            <h1 class="page-header"> {{ $title }} <a href="{{ route('create_new_page') }}"
                                                     class="btn btn-info pull-right"> <i
                            class="fa fa-floppy-o"></i> @lang('app.create_new_page')</a>
            </h1>
        </div> <!-- /.row -->
    @endif
        ...
        <div class="col-xs-12">
            ...
            <div class="form-group {{ $errors->has('title')? 'has-error':'' }}">
                <div class="col-sm-12">
                    ...
                    <input type="text" class="form-control" id="title"
                           value="{{ old('title')?old('title'): $page->title }}" name="title"
            ...
            <div class="form-group {{ $errors->has('slug')? 'has-error':'' }}">
                <div class="col-sm-12">
                    ...
                    <input type="text" disabled class="form-control" id="slug"
                           value="{{ old('slug')?old('slug'): $page->slug }}" name="title"
                           placeholder="@lang('app.slug')">
            ...
            <div class="form-group {{ $errors->has('post_content')? 'has-error':'' }}">
                <div class="col-sm-12">
                    <textarea name="post_content" id="post_content"
                              class="form-control description">{!!  old('post_content')? old('post_content'): $page->post_content !!}</textarea>
                ...
                <div class="col-md-6">
                    <label for="show_in_header_menu" class="checkbox-inline">
                        <input type="checkbox" value="1" id="show_in_header_menu"
                               name="show_in_header_menu" {{ $page->show_in_header_menu? 'checked':'' }}>
                ...
                <div class="col-md-6">
                    <label for="show_in_footer_menu" class="checkbox-inline">
                        <input type="checkbox" value="1" id="show_in_footer_menu"
                               name="show_in_footer_menu" {{ $page->show_in_footer_menu? 'checked':'' }}>
