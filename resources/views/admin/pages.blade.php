    ...
    @if( ! empty($title))
        <div>
            <h1 class="page-header"> {{ $title }}
                <a href="{{ route('create_new_page') }}" class="btn btn-info pull-right"> <i
            ...
            <table class="table table-bordered table-striped" id="jDataTable">
                ...
                @foreach($pages as $page)
                    <tr>
                        ...
                        <td>
                            <a href="{{route('edit_page',$page->slug)}}" class="btn btn-primary"><i
                                        class="fa fa-edit"></i> </a><a href="javascript:;"
                                                                       class="btn btn-danger deletePage"
                                                                       data-slug="{{$page->slug}}"><i
